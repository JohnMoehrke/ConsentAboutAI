# Consent for Machine Learning Training on De-Identified Data - John Moehrke Consent About AI v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Consent for Machine Learning Training on De-Identified Data**

## Example Consent: Consent for Machine Learning Training on De-Identified Data
...
```json
{
  ...
  "id" : "AllowMLtrainingOnDeIdentifiedData",
  "meta" : {
