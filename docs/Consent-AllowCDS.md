# Consent for Clinical Decision Support - John Moehrke Consent About AI v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Consent for Clinical Decision Support**

## Example Consent: Consent for Clinical Decision Support
...
This consent is made under the policy [http://example.org/consent-policies#cds-consent-policy](http://example.org/consent-policies#cds-consent-policy) .
